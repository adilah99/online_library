                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th id="updationDate">Updation Date</th>
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <a href="edit-category.php?catid=<?php echo htmlentities($result->id);?>"><button class="btn btn-primary"><em class="fa fa-edit "></em> Edit</button> 
